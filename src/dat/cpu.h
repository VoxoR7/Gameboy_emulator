...
switch (opcode) {
    case 0: // 0x00 NOP
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x00 NOP");
        #endif
        break;
    case 1: // 0x01 BC = XX XX
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x01 BC = XX XX");
        #endif
        ...
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "BC 0x%04x (%"PRIu16")", registers.bc, registers.bc);
        #endif
        break;
    case 2: // 0x02 *(BC) = A
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x02 *(BC) = A");
        #endif
        ...
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "BC 0x%04x; a 0x%02x (%"PRIu8")", registers.bc, registers.a, registers.a);
        #endif
        break;
    case 3: // 0x03 BC++
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x03 BC++");
        #endif
    ...
    case 4: // 0x04 B++
        ...
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "B 0x%02x (%"PRIu8")", registers.b, registers.b);
        #endif
        break;
    case 5: // 0x05 B--
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x05 B--");
        #endif
    ...
    case 7: // 0x07 ROTATE A LEFT
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x07 ROTATE A LEFT");
        #endif
        ...
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "A 0x%02x (%"PRIu8")", registers.a, registers.a);
        #endif
        break;
    case 8: // 0x08 *(XX XX) = SP
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, " 0x08 *(XX XX) = SP");
        #endif
        ...
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "op16 0x%02x; SP 0x%02x", op16, registers.sp);
        #endif
        break;
    case 9: // 0x09 HL += BC
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x09 HL += BC");
        #endif
        ...
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "HL 0x%04x (%"PRIu16")", registers.hl, registers.hl);
        #endif
        break;
    case 10: // 0x0A A = *(BC)
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x0A A = *(BC)");
        #endif
        ...
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "A 0x%02x (%"PRIu8"); BC 0x%04x", registers.a, registers.a, registers.bc);
        #endif
        break;
    case 11: // 0x0B BC--
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x0B BC--");
        #endif
        ...
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "BC 0x%02x (%"PRIu8")", registers.bc, registers.bc);
        #endif
        break;
    case 12: // 0x0C C++
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x0C C++");
        #endif
        ...
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "C 0x%02x (%"PRIu8")", registers.c, registers.c);
        #endif
        break;
    case 13: // 0x0D C--
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x0D C--");
        #endif
    ...
    case 15: // 0x0F ROTATE A RIGHT
        #ifdef STEP
        if (verbose)
            LOG_MESG(LOG_DEBUG, "0x0F ROTATE A RIGHT");
        #endif
    ...
    case 17: // 0x11 DE = XX XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x11 DE = XX XX REVIEWED\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : de 0x%04x (%"PRIu16")\n", registers.de, registers.de);
        #endif
    ...
    case 18: // 0x12 *(DE) = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x12 *(DE) = A REVIEWED\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : de 0x%02x; a 0x%02x (%"PRIu8")\n", registers.de, registers.a, registers.a);
        #endif
    ...
    case 19: // 0x13 DE++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x13 DE++ REVIEWED\n");
        #endif
    ...
    case 20: // 0x14 D++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x14 D++ REVIEWED\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : d 0x%02x (%"PRIu8")\n", registers.d, registers.d);
        #endif
    ...
    case 21: // 0x15 D--
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x15 D-- REVIEWED\n");
        #endif
    ...
    case 22: // 0x16 D = XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x16 D = XX REVIEWED\n");
        #endif
    ...
    case 24: // 0x18 JMP pc + (signed) XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x18 JMP pc + (signed) XX REVIEWED\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : pc 0x%04x\n", registers.pc);
        #endif
    ...
    case 25: // 0x19 HL += DE
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x19 HL += DE REVIEWED\n");
        #endif
    ...
    case 26: // 0x1A A = *(DE)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x1A A = *(DE) REVIEWED\n");
        #endif
    ...
    case 27: // 0x1B DE--
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x1B DE-- REVIEWED\n");
        #endif
    ...
    case 28: // 0x1C E++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x1C E++ REVIEWED\n");
        #endif
    ...
    case 30: // 0x1E E = XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x1E E = XX\n");
        #endif
    ...
    case 32: // 0x20 JMP pc + (signed) XX if !FLAGS_Z
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x20 JMP pc + (signed) XX if !FLAGS_Z\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : pc 0x%02x\n", registers.pc);
        #endif
    ...
    case 33: // 0x21 HL = XX XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x21 HL = XX\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : hl 0x%04x (%"PRIu16")\n", registers.hl, registers.hl);
        #endif
        break;
    case 34: // 0x22 *(HL) = A; HL++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x22 *(HL) = A; HL++\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : a 0x%02x (%"PRIu8"); hl (after increment) 0x%02x\n", registers.a, registers.a, registers.hl);
        #endif
    ...
    case 35: // 0x23 HL++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x23 HL++\n");
        #endif
    ...
    case 36: // 0x24 H++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : h 0x%02x (%"PRIu8")\n", registers.h, registers.h);
        #endif
    ...
    case 37: // 0x25 H--
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x25 H--\n");
        #endif
    ...
    case 39: // 0x27 ADJUST A FOR BCD
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x27 ADJUST A FOR BCD\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : a 0x%02x\n", registers.a);
        #endif
    ...
    case 40: // 0x28 JMP pc + (signed) XX if FLAGS_Z
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x28 JMP pc + (signed) XX if FLAGS_Z\n");
        #endif
    ...
    case 41: // 0x29 HL += HL
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x29 HL += HL REVIEWED\n");
        #endif
    ...
    case 42: // 0x2A A = *(HL); HL++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x2A A = *(HL); HL++\n");
        #endif
    ...
    case 43: // 0x2B HL--
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x2B HL--\n");
        #endif
    ...
    case 46: // 0x2E L = XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x2E L = XX\n");
        #endif
    ...
    case 47: // 0x2F A = ~A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x2F A = ~A\n");
        #endif
    ...
    case 48: // 0x30 JMP pc + (signed) XX if !FLAGS_C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x30 JMP pc + (signed) XX if !FLAGS_C\n");
        #endif
    ...
    case 49: // 0x31 SP = XX XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x31 SP = XX XX\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : sp = 0x%02x \n", registers.sp);
        #endif
    ...
    case 50: // 0x32 *(HL) = A; HL--
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x32 *(HL) = A; HL--\n");
        #endif
    ...
    case 51: // 0x33 SP++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x33 SP++ REVIEWED\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : sp 0x%04x (%"PRIu16")\n", registers.sp, registers.sp);
        #endif
    ...
    case 52: // 0x34 *(HL)++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] :0x34 *(HL)++\n");
        #endif
    ...
    case 54: // 0x36 *(HL) = XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] :0x36 *(HL) = XX\n");
        #endif
    ...
    case 56: // 0x38 JMP pc + (signed) XX IF FLAGS_C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x38 JMP pc + (signed) XX IF FLAGS_C\n");
        #endif
    ...
    case 58: // 0x3A A = *(HL); HL--
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : a = 0x%02x (%"PRIu8"); HL (after decrement) = 0x%02x\n", registers.a, registers.a, registers.hl);
        #endif
    ...
    case 60: // 0x3C A++
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x3C A++\n");
        #endif
    ...
    case 62: // 0x3E A = XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x3E A = XX\n");
        #endif
    ...
    case 64: // 0x40 B = B
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x40 B = B\n");
        #endif
    ...
    case 66: // 0x42 B = D
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x42 B = D\n");
        #endif
    ...
    case 68: // 0x44 B = H
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x44 B = H\n");
        #endif
    ...
    case 70: // 0x46 B = *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x46 B = *(HL)\n");
        #endif
    ...
    case 71: // 0x47 B = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x47 B = A\n");
        #endif
    ...
    case 75: // 0x4B C = E
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x4B C = E\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : c = 0x%02x (%"PRIu8")\n", registers.c, registers.c);
        #endif
    ...
    case 77: // 0x4D C = L
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x4D C = L\n");
        #endif
    ...
    case 78: // 0x4E C = *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x4E C = *(HL)\n");
        #endif
    ...
    case 79: // 0x4F C = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x4F C = A\n");
        #endif
    ...
    case 80: // 0x50 D = B
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x50 D = B\n");
        #endif
    ...
    case 84: // 0x54 D = H
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x54 D = H\n");
        #endif
    ...
    case 86: // 0x56 D = *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x56 D = *(HL)\n");
        #endif
    ...
    case 87: // 0x57 D = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x57 D = A\n");
        #endif
    ...
    case 93: // 0x5D E = L
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x5D E = L\n");
        #endif
    ...
    case 94: // 0x5E E = *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x5E E = *(HL)\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : e = 0x%02x (%"PRIu8"); hl = 0x%02x\n", registers.e, registers.e, registers.hl);
        #endif
    ...
    case 95: // 0x5F E = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x5F E = A\n");
        #endif
    ...
    case 96: // 0x60 H = B
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x60 H = B\n");
        #endif
    ...
    case 97: // 0x61 H = C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x61 H = C\n");
        #endif
    ...
    case 98: // 0x62 H = D
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x62 H = D\n");
        #endif
    ...
    case 102: // 0x66 H = *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : h = 0x%02x (%"PRIu8"); hl = 0x%02x\n", registers.h, registers.h, registers.hl);
        #endif
    ...
    case 103: // 0x67 H = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x67 H = A\n");
        #endif
    ...
    case 105: // 0x69 L = C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x69 L = C\n");
        #endif
    ...
    case 107: // 0x6B L = E
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x6B L = E\n");
        #endif
    ...
    case 110: // 0x6E L = (*HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x6E L = (*HL)\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : l = 0x%02x (%"PRIu8"); hl = 0x%02x\n", registers.l, registers.l, registers.hl);
        #endif
    ...
    case 111: // 0x6F L = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x6F L = A\n");
        #endif
    ...
    case 112: // 0x70 *(HL) = B
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x70 *(HL) = B\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : b = 0x%02x; hl = 0x%02x\n", registers.b, registers.b);
        #endif
    ...
    case 113: // 0x71 *(HL) = C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x71 *(HL) = C\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : c = 0x%02x; hl = 0x%02x\n", registers.c, registers.c);
        #endif
    ...
    case 114: // 0x72 *(HL) = D
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x72 *(HL) = D\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : d = 0x%02x; hl = 0x%02x\n", registers.d, registers.hl);
        #endif
    ...
    case 115: // 0x73 *(HL) = E
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x73 *(HL) = E\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : e = 0x%02x; hl = 0x%02x\n", registers.e, registers.hl);
        #endif
    ...
    case 119: // 0x77 *(HL) = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x77 *(HL) = A\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : a = 0x%02x; hl = 0x%02x\n", registers.a, registers.hl);
        #endif
    ...
    case 120: // 0x78 A = B
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x78 A = B\n");
        #endif
    ...
    case 121: // 0x79 A = C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x79 A = C\n");
        #endif
    ...
    case 122: // 0x7A A = D
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x7A A = D\n");
        #endif
    ...
    case 123: // 0x7B A = E
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x7B A = E\n");
        #endif
    ...
    case 124: // 0x7C A = H
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x7C A = H\n");
        #endif
    ...
    case 125: // 0x7D A = L
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x7D A = L\n");
        #endif
    ...
    case 126: // 0x7E A = *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x7E A = *(HL)\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : a = 0x%02x (%"PRIu8"); hl 0x%04x\n", registers.a, registers.a, registers.hl);
        #endif
    ...
    case 128: // 0x80 A += B
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x80 A += B\n");
        #endif
    ...
    case 129: // 0x81 A += C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x81 A += C\n");
        #endif
    ...
    case 130: // 0x82 A += D
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x82 A += D\n");
        #endif
    ...
    case 131: // 0x83 A += E
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x83 A += E\n");
        #endif
    ...
    case 132: // 0x84 A += H
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x84 A += H\n");
        #endif
    ...
    case 133: // 0x85 A += L
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x85 A += L\n");
        #endif
    ...
    case 134: // 0x86 A += *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x86 A += *(HL)\n");
        #endif
    ...
    case 135: // 0x87 A = A + A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x87 A = A + A\n");
        #endif
    ...
    case 137: // 0x89 A += C + FLAGS_C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x89 A += C + FLAGS_C\n");
        #endif
    ...
    case 142: // 0x8E A += *(HL) + FLAGS_C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x8E A += *(HL) + FLAGS_C\n");
        #endif
    ...
    // reviewed OK
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x90 A -= B REVIEWED\n");
        #endif
    ...
    case 145: // 0x91 A -= C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x91 A -= C\n");
        #endif
    ...
    case 147: // 0x93 A -= E
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x93 A -= E\n");
        #endif
    ...
    case 150: // 0x96 A -= *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x96 A -= *(HL)\n");
        #endif
    ...
    case 153: // 0x99 A -= (C + C_FLAG)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x99 A -= (C + C_FLAG)\n");
        #endif
    ...
    // reviewed
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xA0 A &= B REVIEWED\n");
        #endif
    ...
    // reviewed
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xA1 A &= C REVIEWED\n");
        #endif
    ...
    // reviewed
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xA7 A &= A REVIEWED\n");
        #endif
    ...
    case 168: // 0xA8 A ^= B
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xA8 A ^= B REVIEWED\n");
        #endif
    ...
    case 169: // 0xA9 A ^= C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xA9 A ^= C REVIEWED\n");
        #endif
    ...
    case 170: // 0xAA A ^= E
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xAA A ^= E REVIEWED\n");
        #endif
    ...
    case 174: // 0xAE A ^= *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] :  0xAE A ^= *(HL)\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : hl 0x%02x; *(hl) 0x%02x; a 0x%02x\n", registers.hl, memory_read8(registers.hl), registers.a);
        #endif
    ...
    case 175: // 0xAF A = A ^ A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xAF A = A ^ A\n");
        #endif
    ...
    case 176: // 0xB0 A = A | B
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xB0 A = A | B\n");
        #endif
    ...
    case 177: // 0xB1 A = A | C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xB1 A = A | C\n");
        #endif
    ...
    case 178: // 0xB2 A = A | D
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xB2 A = A | D\n");
        #endif
    ...
    case 179: // 0xB3 A = A | E
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xB3 A = A | E\n");
        #endif
    ...
    case 182: // 0xB6 A = A | *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xB6 A = A | *(HL)\n");
        #endif
    ...
    case 183: // 0xB7 A = A | A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xB2 A = A | A\n");
        #endif
    ...
    case 184: // 0xB8 A == B
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xB8 A == B\n");
        #endif
    ...
    case 185: // 0xB9 A == C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xB9 A == C\n");
        #endif
    ...
    case 186: // 0xBA A == D
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xBA A == D\n");
        #endif
    ...
    case 187: // 0xBB A == E
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xBB A == E\n");
        #endif
    ...
    case 188: // 0xBC A == H
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xBC A == H\n");
        #endif
    ...
    case 189: // 0xBD A == L
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xBD A == L\n");
        #endif
    ...
    case 190: // 0xBE *(HL) == A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xBE *(HL) == A\n");
        #endif
    ...
    case 191: // 0xBF A == A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xBF A == A\n");
        #endif
    ...
    case 192: // 0xC0 RET IF !FLAGS_Z
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xC0 RET IF !FLAGS_Z\n");
        #endif
    ...
    case 193: // 0xC1 POP BC
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xC1 POP BC\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : bc 0x%02x (%"PRIu16")\n", registers.bc, registers.bc);
        #endif
    ...
    case 194: // 0xC2 JMP XX XX IF LAST RESULT !FLAGS_Z
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xC2 JMP XX XX IF LAST RESULT !FLAGS_Z\n");
        #endif
    ...
    case 195: // 0xC3 JMP XX XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xC3 JMP XX XX\n");
        #endif
    ...
    case 196: // 0xC4 CALL XX XX IF !FLAGS_Z
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xC4 CALL XX XX IF !FLAGS_Z\n");
        #endif
    ...
    case 197: // 0xC5 PUSH BC
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xC5 PUSH BC\n");
        #endif
    ...
    case 200: // 0xC8 RET IF FLAGS_Z
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xC8 RET IF FLAGS_Z\n");
        #endif
    ...
    case 201: // 0xC9 RET
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xC9 RET\n");
        #endif
    ...
    case 202: // 0xCA JMP XX XX IF FLAGS_Z
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xCA JMP XX XX IF FLAGS_Z\n");
        #endif
    ...
    case 203: // 0xCB : EXTENDED OPERATION
        ...
        switch (op8) {
            ...
            default:
                ...
                #ifdef DEBUG
                    LOG_MESG(LOG_DEBUG, "Extended instruction 0x%02x (%"PRIu8") not implemented. crashed after %"PRIu64" instructions", op8, op8, registers.ex);
                    LOG_MESG(LOG_DEBUG, "\tPC 0x%02x <> SP %d (0x%02x)\n", registers.pc, registers.sp, registers.sp);
                    LOG_MESG(LOG_DEBUG, "\tA %d (0x%02x) <> F %d (0x%02x) <> AF %d (0x%02x)\n", registers.a, registers.a, registers.f, registers.f, registers.af, registers.af);
                #endif
    ...
    case 205: // 0xCD CALL XX XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xCD CALL XX XX\n");
        #endif
    ...
    case 209: // 0xD1 POP DE
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xD1 POP DE\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : de 0x%02x (%"PRIu16")\n", registers.de, registers.de);
        #endif
    ...
    case 216: // 0xD8 RET IF FLAGS_C
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xD8 RET IF FLAGS_C\n");
        #endif
    ...
    case 217: // 0xD9 RETI
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xD9 RETI\n");
        #endif
    ...
    case 222: // 0xDE A -= (XX + C_FLAG)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xDE A -= (XX + C_FLAG)\n");
        #endif
        ...
        if (registers.f & FLAGS_C) {
            ...
            #ifdef STEP
                if (verbose)
                    LOG_MESG(LOG_DEBUG, "[INFO] : a 0x%02x (%"PRIu8"); XX 0x%02x (%"PRIu8"); carry YES; res a 0x%02x (%"PRIu8")\n", registers.a, registers.a, op8, op8, (uint8_t)(registers.a - op8), (uint8_t)(registers.a - op8 - 1));
            #endif
            ...
            #ifdef STEP
                if (verbose)
                    LOG_MESG(LOG_DEBUG, "[INFO] : a 0x%02x (%"PRIu8"); XX 0x%02x (%"PRIu8"); carry NO; res a 0x%02x (%"PRIu8")\n", registers.a, registers.a, op8, op8, (uint8_t)(registers.a - op8), (uint8_t)(registers.a - op8));
            #endif
    ...
    case 224: // 0xE0 *(0xFF00 + XX) = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xE0 *(0xFF00 + XX) = A\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : *(0xFF00 + XX -> 0x%02x) = 0x%02x\n", op8, memory_read8(0xFF00 + op8));
        #endif
    ...
    case 225: // 0xE1 POP HL
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xE1 POP HL\n");
        #endif
    ...
    case 226: // 0xE2 *(0xFF00 + C) = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xE2 *(0xFF00 + C) = A\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : *(0xFF00 + C -> 0x%02x) = 0x%02x\n", registers.c, memory_read8(0xFF00 + registers.c));
        #endif
    ...
    case 229: // 0xE5 PUSH HL
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xE5 PUSH HL\n");
        #endif
    ...
    case 230: // 0xE6 A = A & XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xE6 A = A & XX\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : a 0x%02x (%"PRIu8"); immmediate : 0x%02x\n", registers.a, registers.a, op8);
        #endif
    ...
    case 232: // 0xE8 SP += XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xE8 SP += (signed)XX\n");
        #endif
    ...
    case 233: // 0xE9 JMP *(HL)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xE9 JMP *(HL)\n");
        #endif
    ...
    case 234: // 0xEA *(XX XX) = A
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] :0xEA *(XX XX) = A\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0x%02x = 0x%02x (%"PRIu8")\n", op16, registers.a, registers.a);
        #endif
    ...
    case 238: // 0xEE A ^= XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] :  0xEE A ^= XX\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : value = 0x%02x; a 0x%02x\n", op8, registers.a);
        #endif
    ...
    case 239: // 0xEF RST 0x28
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xEF RST 0x28\n");
        #endif
    ...
    case 243: // 0xF3 disable interrupt
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xF3 disable interrupt\n");
        #endif
    ...
    case 245: // 0xF5 PUSH AF
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xF5 PUSH AF\n");
        #endif
    ...
    case 246: // 0xF6 A |= XX
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xF6 A |= XX\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : a 0x%02x (%"PRIu8"); XX = 0x%02x\n", registers.a, registers.a, op8);
        #endif
    ...
    case 249: // 0xF9 SP = HL
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xF9 SP = HL\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : sp 0x%04x\n", registers.sp);
        #endif
    ...
    case 250: // 0xFA A = *(XX XX)
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xFA A = *(XX XX)\n");
        #endif
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : a 0x%02x (%"PRIu8"); XX XX -> 0x%04x\n", registers.a, registers.a, op16);
        #endif
    ...
    case 251: // 0xFB enable interrupt
        ...
        #ifdef STEP
            if (verbose)
                LOG_MESG(LOG_DEBUG, "[INFO] : 0xFB enable interrupt\n");
        #endif
    ...
    default:
        #ifdef DEBUG
            LOG_MESG(LOG_FATAL, "Instruction %d (0x%02x) not implemented. crashed after %"PRIu64" instructions and %"PRIu64" time", opcode, opcode, registers.ex, emul_time);
            LOG_MESG(LOG_FATAL, "\tPC 0x%02x <> sp %d (0x%02x)", registers.pc, registers.sp, registers.sp);
            LOG_MESG(LOG_FATAL, "\tA %"PRIu8" (0x%02x) <> F %"PRIu8" (0x%02x) <> AF %"PRIu16" (0x%02x)", registers.a, registers.a, registers.f, registers.f, registers.af, registers.af);
            LOG_MESG(LOG_FATAL, "\tB %"PRIu8" (0x%02x) <> C %"PRIu8" (0x%02x) <> BC %"PRIu16" (0x%02x)", registers.b, registers.b, registers.c, registers.c, registers.bc, registers.bc);
            LOG_MESG(LOG_FATAL, "\tD %"PRIu8" (0x%02x) <> E %"PRIu8" (0x%02x) <> DE %"PRIu16" (0x%02x)", registers.d, registers.d, registers.e, registers.e, registers.de, registers.de);
            LOG_MESG(LOG_FATAL, "\tH %"PRIu8" (0x%02x) <> L %"PRIu8" (0x%02x) <> HL %"PRIu16" (0x%02x)", registers.h, registers.h, registers.l, registers.l, registers.hl, registers.hl);
        #endif
